...
namespace BSK_proj2.Data.Migrations
{
    ...
    [Migration("20190609162116_CommentsOwner")]
    partial class CommentsOwner
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BSK_proj2.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BSK_proj2.Models.Permission<BSK_proj2.Models.Image>", b =>
                {
                    b.HasOne("BSK_proj2.Models.Image", "Object")
                        .WithMany("ImagePermissions")
                        .HasForeignKey("ObjectID");
